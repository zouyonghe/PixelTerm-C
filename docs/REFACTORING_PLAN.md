...
- Keep `README.md`, `docs/PROJECT_STATUS.md`, and `docs/DEVELOPMENT.md` aligned with release `v1.7.5`, `bin/pixelterm`, and the landed repository layout.
...
- Completed:
  ...
  - Synced README/project/development/architecture docs to shipped release `v1.7.5`, current repository layout, and `bin/pixelterm` build output.
