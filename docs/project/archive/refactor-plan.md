...
3. Keep docs aligned with the shipped release (`v1.7.8`) and Makefile output (`bin/pixelterm`).
...
- Docs are synced to release `v1.7.8`, the current repository layout, and the `bin/pixelterm` source-build output.
