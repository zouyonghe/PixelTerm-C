...
typedef struct {
    ...
    gint render_book_page_calls;
    gint preview_page_move_calls;
    gint book_preview_scroll_page_calls;
    gint file_manager_up_calls;
    gint file_manager_down_calls;
    gint file_manager_enter_at_position_calls;
    gboolean current_is_video;
    gint64 last_video_seek_delta_ms;
    gint last_book_page_index;
    gint last_preview_page_move_direction;
    gint last_book_preview_scroll_direction;
    gint last_file_manager_enter_x;
    gint last_file_manager_enter_y;
